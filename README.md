# grunt-contrib-requirejs [![Build Status](https://secure.travis-ci.org/gjurgens/grunt-annotated-requirejs.png?branch=master)](http://travis-ci.org/gruntjs/grunt-contrib-requirejs)
